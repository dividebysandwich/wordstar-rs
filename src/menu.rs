...
static EDIT: &[MenuItem] = &[
    ...
    item("Write Block to File...", "^KW", Command::WriteBlock),
    item("Block to UPPER Case", "^K\"", Command::ChangeCase(crate::app::Case::Upper)),
    item("Block to lower Case", "^K'", Command::ChangeCase(crate::app::Case::Lower)),
    item("Block to Sentence Case", "^K.", Command::ChangeCase(crate::app::Case::Sentence)),
    SEP,
    ...
    item("Go to Heading...", "^QG", Command::GotoHeading),
...
static INSERT: &[MenuItem] = &[
    ...
    item("Include File (.fi)...", "", Command::IncludeFile),
    SEP,
